...
test.describe('Web Worker Integration', () => {
  ...
  test('should compute peaks on main thread when worker disabled', async ({ page }) => {
    await page.goto('/')
  ...
  test('should handle worker computation with different audio sources', async ({ page }) => {
    await page.goto('/')
  ...
  test('should progressively render waveform as peaks are computed', async ({ page }) => {
