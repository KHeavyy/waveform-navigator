...
describe('useWaveformData when AudioContext is missing', () => {
  it('calls onError with AudioContext not supported message', async () => {
    ...
    function TestComponent() {
      ...
      useWaveformData({ audio: file, width: 100, barWidth: 2, gap: 1, onPeaksComputed, onError } as any)
      return <div />
    }
    ...
    expect(onError.mock.calls[0][0].message).toContain('AudioContext not supported')
